...
// compile: g++ -std=c++14 -Wall -g -ggdb RH_ENUM_CLASS_ITEM_UTYPE_SHELL_demo.cxx -o RH_ENUM_CLASS_ITEM_UTYPE_SHELL_demo -I../../server
...
//                           itemName, item, index, name, itemIndex, Item}
RH_ENUM_CLASS_ITEM_UTYPE_SHELL(
  SmokeyStover, Shtuka, short, foo = 1, bar, baz, qux,
  foobar = foo + bar, initial = baz,
  itemName, item, index, name, itemIndex, Item, ItemProxy = foobar);
...
int main(int argc, char **argv) {
  ...
  SmokeyStover smokeyStover = SmokeyStover::Shtuka::qux;
...
// Local Variables:
// compile-command: "g++ -std=c++14 -Wall -g -ggdb RH_ENUM_CLASS_ITEM_UTYPE_SHELL_demo.cxx -o RH_ENUM_CLASS_ITEM_UTYPE_SHELL_demo -I../../server"
// End:
